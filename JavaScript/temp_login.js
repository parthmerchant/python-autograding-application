function getLoginInfo() {
        ...
        AJAX_Request.onreadystatechange = function(){
            ...
            if(AJAX_Request.readyState == 4){
                ...
                // Check if NJIT Login was Successful or Unsuccessful
                if (data['NJIT'] == "Success") responseContent.innerHTML = "<h3><center>Welcome!</center></h3><h4><center>NJIT Login Successful</center></h4>";
                else responseContent.innerHTML = "<h4><center>NJIT Login Failed</center></h4>";
                
                // Check if Project Login was Successful or Unsuccessful
