...
var middle_path = "https://web.njit.edu/~pmm44/beta_middle.php";
        ...
        AJAX_Request.onreadystatechange = function(){
            ...
            if(AJAX_Request.readyState == 4){
                ...
                rc.innerHTML = '';
                for(i=1;i<=num;i++){
                	var tcs = data['que_'+i+'']['no_of_testcases'];
                	...
                	rc.innerHTML += '<hr>';
                	rc.innerHTML += 'Points deducted for wrong function name: '+data['ans_'+i+'_comments']['auto_fun_name'];
                	rc.innerHTML += '<br>';
                	rc.innerHTML += 'Points deducted for wrong argument name: '+data['ans_'+i+'_comments']['auto_arg_name'];
                	rc.innerHTML += '<br>';
                	rc.innerHTML += 'Points deducted for invalid constraints: '+data['ans_'+i+'_comments']['auto_invalid_constrain'];
                	rc.innerHTML += '<br>';
                	rc.innerHTML += 'Points deducted for wrong output: '+data['ans_'+i+'_comments']['auto_wrong_output'];
                	rc.innerHTML += '<br>';
                	rc.innerHTML += 'Points deducted for missing parentheses: '+data['ans_'+i+'_comments']['auto_paren'];
                	rc.innerHTML += '<br>';
                	rc.innerHTML += 'Points deducted for missing colon: '+data['ans_'+i+'_comments']['auto_colon'];
                	rc.innerHTML += '<hr>';
                	for(j=1; j<=tcs; j++){
                		var t1 = data['que_'+i+'']['que_tc_in_'+j+''];
                		var t2 = '<td>'+data['que_'+i+'']['que_tc_out_'+j+''];
                		var t3 = '<td>'+data['ans_'+i+'_comments']['output_'+j+''];
                		var t4 = '<td>'+data['ans_'+i+'_comments']['testcase_'+j+''];
                		rc.innerHTML += 'Input: '+t1+' | Expected Output: '+t2+' | Your Output: '+t3+' | Points Deducted: '+t4;
                		rc.innerHTML += '<br>';
                	}
                	rc.innerHTML += '<hr>';
                	...
                	rc.innerHTML += '<br>';
                  	...
                  	rc.innerHTML += '<br>';
                	rc.innerHTML += '<hr class="new5">';
                }
                rc.innerHTML += 'Final Comments: ' + data["final_comments"];
                rc.innerHTML += '<hr>';
                rc.innerHTML += 'Final Score: ' + data["final_score"] +'/'+data["total_score"];
